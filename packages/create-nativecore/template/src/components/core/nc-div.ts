...
export class NcDiv extends CoreComponent {
    static useShadowDOM = true;

    static observedAttributes = ['layout', 'cols', 'direction', 'gap', 'width', 'justify', 'align'];
    static attributeOrder     = ['layout', 'cols', 'direction', 'gap', 'width', 'justify', 'align'];
    ...
    // (kept for dev-tools integration)
    ...
    // Pure CSS — no _handleAttributeUpdate needed; :host([attr]) selectors handle all changes.
}

if (!customElements.get('nc-div')) customElements.define('nc-div', NcDiv);
