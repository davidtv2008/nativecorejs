...
function packageJsonTemplate(config) {
    const scripts = {
        ...
        compile: 'node .nativecore/scripts/write-public-env.mjs && node .nativecore/scripts/watch-compile.mjs --once && node .nativecore/scripts/bundle-css.mjs && node .nativecore/scripts/sync-importmap.mjs',
        ...
        'remove:store': 'node .nativecore/scripts/remove-store.mjs',
        'remove:middleware': 'node .nativecore/scripts/remove-middleware.mjs',
        test: 'vitest',
        'test:ui': 'vitest --ui',
