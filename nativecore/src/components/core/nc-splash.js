...
class NcSplash extends Component {
  ...
  onMount() {
    ...
    const shouldSkipSplash = window.matchMedia("(max-width: 768px)").matches || window.matchMedia("(prefers-reduced-motion: reduce)").matches || connection?.saveData === true;
