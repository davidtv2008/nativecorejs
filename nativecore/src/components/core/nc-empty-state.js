...
class NcEmptyState extends Component {
  ...
  template() {
    ...
    const variantStyle = variant === "bordered" ? "border: 1px dashed var(--nc-border); border-radius: var(--nc-radius-lg);" : variant === "filled" ? "background: var(--nc-bg-secondary); border-radius: var(--nc-radius-lg);" : "";
