...
class NcFileUpload extends Component {
  ...
  template() {
    ...
    const fileList = this._files.length ? this._files.map((f, i) => `
    ...
    return html`
            ...
            <div class="drop-zone${this._dragging ? " dragging" : ""}${disabled ? " disabled" : ""}">
                ...
                ${isCompact ? `<span class="drop-label"><span class="browse-link">Browse</span> or drop files here</span>` : `<span class="drop-label">Drop files here or <span class="browse-link">browse</span></span>
