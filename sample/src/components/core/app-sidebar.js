...
export class AppSidebar extends Component {
    ...
    onMount() {
        ...
        this.collapseLabel = computed(() => uiStore.sidebarCollapsed.value ? 'Expand sidebar' : 'Collapse sidebar');
